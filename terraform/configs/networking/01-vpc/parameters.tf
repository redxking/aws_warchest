...
resource "aws_ssm_parameter" "default_network_acl_id" {
  ...
  type        = "String"
  value       = try(module.vpc.default_network_acl_id, "null")
}
...
resource "aws_ssm_parameter" "default_route_table_id" {
  ...
  type        = "String"
  value       = try(module.vpc.default_route_table_id, "null")
}
...
resource "aws_ssm_parameter" "vpc_instance_tenancy" {
  ...
  type        = "String"
  value       = try(module.vpc.vpc_instance_tenancy, "null")
}
...
resource "aws_ssm_parameter" "vpc_enable_dns_support" {
  ...
  type        = "String"
  value       = try(module.vpc.vpc_enable_dns_support, "null")
}
...
resource "aws_ssm_parameter" "vpc_enable_dns_hostnames" {
  ...
  type        = "String"
  value       = try(module.vpc.vpc_enable_dns_hostnames, "null")
}
...
resource "aws_ssm_parameter" "vpc_ipv6_association_id" {
  ...
  type        = "String"
  value       = length(module.vpc.vpc_ipv6_association_id) > 0 ? module.vpc.vpc_ipv6_association_id :  "null"
}
...
resource "aws_ssm_parameter" "vpc_secondary_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.vpc_secondary_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "private_subnets" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.private_subnets)), "null")
}
...
resource "aws_ssm_parameter" "private_subnet_arns" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.private_subnet_arns)), "null")
}
...
resource "aws_ssm_parameter" "private_subnets_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.private_subnets_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "private_subnets_ipv6_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.private_subnets_ipv6_cidr_block)), "null")
}
...
resource "aws_ssm_parameter" "public_subnets" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.public_subnets)), "null")
}
...
resource "aws_ssm_parameter" "public_subnet_arns" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.public_subnet_arns)), "null")
}
...
resource "aws_ssm_parameter" "public_subnets_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.public_subnets_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "public_subnets_ipv6_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.public_subnets_ipv6_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "outpost_subnets" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.outpost_subnets)), "null")
}
...
resource "aws_ssm_parameter" "outpost_subnet_arns" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.outpost_subnet_arns)), "null")
}
...
resource "aws_ssm_parameter" "outpost_subnets_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.outpost_subnets_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "outpost_subnets_ipv6_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.outpost_subnets_ipv6_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "database_subnets" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.database_subnets)), "null")
}
...
resource "aws_ssm_parameter" "database_subnet_arns" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.database_subnet_arns)), "null")
}
...
resource "aws_ssm_parameter" "database_subnets_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.database_subnets_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "database_subnets_ipv6_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.database_subnets_ipv6_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "database_subnet_group" {
  ...
  type        = "String"
  value       = try(module.vpc.database_subnet_group, "null")
}
...
resource "aws_ssm_parameter" "redshift_subnets" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.redshift_subnets)), "null")
}
...
resource "aws_ssm_parameter" "redshift_subnet_arns" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.redshift_subnet_arns)), "null")
}
...
resource "aws_ssm_parameter" "redshift_subnets_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.redshift_subnets_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "redshift_subnets_ipv6_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.redshift_subnets_ipv6_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "elasticache_subnets" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.elasticache_subnets)), "null")
}
...
resource "aws_ssm_parameter" "elasticache_subnet_arns" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.elasticache_subnet_arns)), "null")
}
...
resource "aws_ssm_parameter" "elasticache_subnets_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.elasticache_subnets_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "intra_subnets" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.intra_subnets)), "null")
}
...
resource "aws_ssm_parameter" "intra_subnet_arns" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.intra_subnet_arns)), "null")
}
...
resource "aws_ssm_parameter" "intra_subnets_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.intra_subnets_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "intra_subnets_ipv6_cidr_blocks" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.intra_subnets_ipv6_cidr_blocks)), "null")
}
...
resource "aws_ssm_parameter" "public_route_table_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.public_route_table_ids)), "null")
}
...
resource "aws_ssm_parameter" "private_route_table_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.private_route_table_ids)), "null")
}
...
resource "aws_ssm_parameter" "database_route_table_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.database_route_table_ids)), "null")
}
...
resource "aws_ssm_parameter" "redshift_route_table_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.redshift_route_table_ids)), "null")
}
...
resource "aws_ssm_parameter" "elasticache_route_table_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.elasticache_route_table_ids)), "null")
}
...
resource "aws_ssm_parameter" "intra_route_table_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.intra_route_table_ids)), "null")
}
...
resource "aws_ssm_parameter" "public_internet_gateway_ipv6_route_id" {
  ...
  type        = "String"
  value       = try(module.vpc.public_internet_gateway_ipv6_route_id, "null")
}
...
resource "aws_ssm_parameter" "database_internet_gateway_route_id" {
  ...
  type        = "String"
  value       = try(module.vpc.database_internet_gateway_route_id, "null")
}
...
resource "aws_ssm_parameter" "database_nat_gateway_route_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.database_nat_gateway_route_ids)), "null")
}
...
resource "aws_ssm_parameter" "database_ipv6_egress_route_id" {
  ...
  type        = "String"
  value       = try(module.vpc.database_ipv6_egress_route_id, "null")
}
...
resource "aws_ssm_parameter" "private_nat_gateway_route_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.private_nat_gateway_route_ids)), "null")
}
...
resource "aws_ssm_parameter" "private_ipv6_egress_route_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.private_ipv6_egress_route_ids)), "null")
}
...
resource "aws_ssm_parameter" "private_route_table_association_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.private_route_table_association_ids)), "null")
}
...
resource "aws_ssm_parameter" "database_route_table_association_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.database_route_table_association_ids)), "null")
}
...
resource "aws_ssm_parameter" "redshift_route_table_association_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.redshift_route_table_association_ids)), "null")
}
...
resource "aws_ssm_parameter" "redshift_public_route_table_association_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.redshift_public_route_table_association_ids)), "null")
}
...
resource "aws_ssm_parameter" "elasticache_route_table_association_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.elasticache_route_table_association_ids)), "null")
}
...
resource "aws_ssm_parameter" "intra_route_table_association_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.intra_route_table_association_ids)), "null")
}
...
resource "aws_ssm_parameter" "public_route_table_association_ids" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.public_route_table_association_ids)), "null")
}
...
resource "aws_ssm_parameter" "dhcp_options_id" {
  ...
  type        = "String"
  value       = try(module.vpc.dhcp_options_id, "null")
}
...
resource "aws_ssm_parameter" "nat_ids" {
  ...
  type        = "String"
  value       = try(tostring(module.vpc.nat_ids), "null")
}
...
resource "aws_ssm_parameter" "nat_public_ips" {
  ...
  type        = "String"
  value       = try(tostring(module.vpc.nat_public_ips), "null")
}
...
resource "aws_ssm_parameter" "natgw_ids" {
  ...
  type        = "String"
  value       = try(tostring(module.vpc.natgw_ids), "null")
}
...
resource "aws_ssm_parameter" "egress_only_internet_gateway_id" {
  ...
  type        = "String"
  value       = try(module.vpc.egress_only_internet_gateway_id, "null")
}
...
resource "aws_ssm_parameter" "cgw_ids" {
  ...
  type        = "String"
  value       = try(tostring(module.vpc.cgw_ids), "null")
}
...
resource "aws_ssm_parameter" "cgw_arns" {
  ...
  type        = "String"
  value       = try(tostring(module.vpc.cgw_arns), "null")
}
...
resource "aws_ssm_parameter" "vgw_arn" {
  ...
  type        = "String"
  value       = try(module.vpc.vgw_arn, "null")
}
...
resource "aws_ssm_parameter" "default_vpc_arn" {
  ...
  type        = "String"
  value       = try(module.vpc.default_vpc_arn, "null")
}
...
resource "aws_ssm_parameter" "default_vpc_cidr_block" {
  ...
  type        = "String"
  value       = try(module.vpc.default_vpc_cidr_block, "null")
}
...
resource "aws_ssm_parameter" "default_vpc_default_network_acl_id" {
  ...
  type        = "String"
  value       = try(module.vpc.default_vpc_default_network_acl_id, "null")
}
...
resource "aws_ssm_parameter" "default_vpc_default_route_table_id" {
  ...
  type        = "String"
  value       = try(module.vpc.default_vpc_default_route_table_id, "null")
}
...
resource "aws_ssm_parameter" "default_vpc_instance_tenancy" {
  ...
  type        = "String"
  value       = try(module.vpc.default_vpc_instance_tenancy, "null")
}
...
resource "aws_ssm_parameter" "default_vpc_enable_dns_support" {
  ...
  type        = "String"
  value       = try(module.vpc.default_vpc_enable_dns_support, "null")
}
...
resource "aws_ssm_parameter" "default_vpc_enable_dns_hostnames" {
  ...
  type        = "String"
  value       = try(module.vpc.default_vpc_enable_dns_hostnames, "null")
}
...
resource "aws_ssm_parameter" "default_vpc_main_route_table_id" {
  ...
  type        = "String"
  value       = try(module.vpc.default_vpc_main_route_table_id, "null")
}
...
resource "aws_ssm_parameter" "outpost_network_acl_arn" {
  ...
  type        = "String"
  value       = try(module.vpc.outpost_network_acl_arn, "null")
}
...
resource "aws_ssm_parameter" "intra_network_acl_arn" {
  ...
  type        = "String"
  value       = try(module.vpc.intra_network_acl_arn, "null")
}
...
resource "aws_ssm_parameter" "database_network_acl_arn" {
  ...
  type        = "String"
  value       = try(module.vpc.database_network_acl_arn, "null")
}
...
resource "aws_ssm_parameter" "redshift_network_acl_id" {
  ...
  type        = "String"
  value       = try(module.vpc.redshift_network_acl_id, "null")
}
...
resource "aws_ssm_parameter" "redshift_network_acl_arn" {
  ...
  type        = "String"
  value       = try(module.vpc.redshift_network_acl_arn, "null")
}
...
resource "aws_ssm_parameter" "elasticache_network_acl_id" {
  ...
  type        = "String"
  value       = try(module.vpc.elasticache_network_acl_id, "null")
}
...
resource "aws_ssm_parameter" "elasticache_network_acl_arn" {
  ...
  type        = "String"
  value       = try(module.vpc.elasticache_network_acl_arn, "null")
}
...
resource "aws_ssm_parameter" "vpc_flow_log_destination_type" {
  ...
  type        = "String"
  value       = try(module.vpc.vpc_flow_log_destination_type, "null")
}
...
resource "aws_ssm_parameter" "azs" {
  ...
  type        = "StringList"
  value       = try(join(",", tolist(module.vpc.azs)), "null")
}
