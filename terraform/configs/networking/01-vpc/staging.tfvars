...
vpc_intra_subnet_cidr_blocks      = {
    us-east-1 = ["172.16.136.0/24", "172.16.137.0/24"]
}
...
vpc_database_subnet_cidr_blocks   = {
    us-east-1 = ["172.16.138.0/24", "172.16.139.0/24"]
}
...
vpc_private_subnet_cidr_blocks    = {
   us-east-1 = ["172.16.140.0/24", "172.16.141.0/24"]
}
...
vpc_public_subnet_cidr_blocks    = {
    us-east-1 = ["172.16.142.0/24", "172.16.143.0/24"]
}
