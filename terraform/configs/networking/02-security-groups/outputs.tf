...
output "transit_gateway_security_group_description" {
  ...
  value       = module.routes3_resolver_sg.security_group_description 
}
...
output "routes3_resolver_security_group_arn" {
  description = "The ARN of the security group (Route53 Resolver)"
  value       = module.routes3_resolver_sg.security_group_arn 
}

output "routes3_resolver_security_group_id" {
  description = "The ID of the security group (Route53 Resolver)"
  value       = module.routes3_resolver_sg.security_group_id
}

output "routes3_resolver_security_group_vpc_id" {
  description = "The VPC ID (Route53 Resolver)"
  value       = module.routes3_resolver_sg.security_group_vpc_id 
  sensitive   = true
}

output "routes3_resolver_security_group_owner_id" {
  description = "The owner ID (Route53 Resolver)"
  value       = module.routes3_resolver_sg.security_group_owner_id 
}

output "routes3_resolver_security_group_name" {
  description = "The name of the security group (Route53 Resolver)"
  value       = module.routes3_resolver_sg.security_group_name 
}

output "routes3_resolver_security_group_description" {
