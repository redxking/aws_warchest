...
plugin "aws" {
  enabled    = true
  deep_check = true
  version    = "0.14.0" # This should be the same version as in `generate-tflint-config/Makefile`.
...
rule "aws_amplify_domain_association_invalid_domain_name" {
  enabled = true
}
...
rule "aws_spot_instance_request_invalid_instance_interruption_behaviour" {
  enabled = true
}
